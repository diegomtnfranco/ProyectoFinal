...
//     // Si el espacio está reservado y tenemos una reserva activa, usar sus datos
...
//       return;
//     }
//     // Si no, mostrar modal para walk-in
